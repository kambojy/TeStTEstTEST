...
if(crcu == myUid*1){acsel = true;jetOn = true;}
	...
	STAT : function(){
		...
		win2 = user.allWin - this.win1;
		lose2 = user.allLose - this.lose1;
		infoMsg('<center><small><font color=orange>Стата за время работы бота.</font></small>', 'Побед : <font color=green>' + win2 + ' ('+user.allWin+')</font><br>Поражений : <font color=red>' + lose2 + ' ('+user.allLose+')</font> <font color=gray>________________________</font><br>Рейтинг : <font color=yellow>'+user.rate+'</font><br>Побед за неделю : <font color=yellow>'+user.wins+'</font> <font color=gray>________________________</font><br><font color=aqua>Бот работает : '+time.toFixed(2)+' минут.</font>');
	}
