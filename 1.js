...
var DRAW = function(){var IMG = document.createElement("IMG");IMG.src = 'http://u913404y.beget.tech/phch/DRAW.png';IMG.id='DRAW';$('#canvasDiv').append(IMG);$('#DRAW')[0].class = "gadjet_icon";$('#DRAW')[0].style.position='absolute';$('#DRAW')[0].style.right='15px';$('#DRAW')[0].style.cursor='pointer';$('#DRAW')[0].style.zIndex='987656';$('#DRAW')[0].onclick=function(){AUTO.draw();}}
