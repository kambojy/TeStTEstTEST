...
var fritndG = function(){var IMG = document.createElement("IMG");IMG.width=23*1.5;IMG.height=23*1.5;IMG.src = 'http://u913404y.beget.tech/phch/fritndG.png';IMG.id='fritndG';$('#canvasDiv').append(IMG);$('#fritndG')[0].style.position='absolute';$('#fritndG')[0].style.left='430px';$('#fritndG')[0].style.cursor='pointer';$('#fritndG')[0].style.zIndex='987656';$('#fritndG')[0].style.top=0+'px';$('#fritndG')[0].onclick=function(){$(this).remove();if(AUTO.fritndG==false){AUTO.fritndG=true;$(this).src='http://u913404y.beget.tech/phch/fritndG.png';}else{AUTO.fritndG=false;$(this).src='http://u913404y.beget.tech/phch/fritndGr.png';if(raceWithFriend){acsel = false;jetOn = false;}};};}
